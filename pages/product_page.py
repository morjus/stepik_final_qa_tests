...
class ProductPage(BasePage):
    ...
    def should_see_success_message(self):
        assert self.is_element_present(*ProductPageLocators.ADDED_TO_CART_MESSAGE), "No success message."
    ...
    def cost_of_product_equal_to_cart_cost(self):
        ...
        result_cost = self.browser.find_element(*ProductPageLocators.CART_COST).text
